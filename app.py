...
grosses_occasions_A = st.number_input("Grosses occasions", min_value=0, value=5)  
grosses_occasions_ratees_A = st.number_input("Grosses occasions ratées", min_value=0, value=2)  
...
penalties_obtenus_A = st.number_input("Pénalties obtenus", min_value=0, value=1)  
touches_surface_adverse_A = st.number_input("Touches dans la surface adverse", min_value=0, value=10)  
corners_A = st.number_input("Nombre de corners", min_value=0, value=4)  
corners_par_match_A = st.number_input("Nombre de corners par match", min_value=0, value=2)  
corners_concedes_A = st.number_input("Nombre de corners concédés par match", min_value=0, value=3)  
...
penalties_concedes_A = st.number_input("Pénalties concédés", min_value=0, value=0)  
...
cartons_jaunes_A = st.number_input("Cartons jaunes", min_value=0, value=2)  
cartons_rouges_A = st.number_input("Cartons rouges", min_value=0, value=0)  
tactique_A = st.text_input("Tactique de l'équipe A", value="4-3-3")  
joueurs_cles_A = st.text_input("Joueurs clés de l'équipe A", value="Joueur 1, Joueur 2")  
