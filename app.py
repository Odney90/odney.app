...
# Exemple de jeu de données par défaut avec 15 variables par équipe + résultat
donnees_defaut = """
...
if fichier_csv:
    ...
    df_entrainement = pd.read_csv(pd.compat.StringIO(donnees_defaut))
...
# Pour chaque équipe, nous avons 15 variables. Voici la répartition :

# Équipe A (Domicile) Variables :
# 1. ⚽ xG_A  
# 2. 🎯 Tirs cadrés_A  
# 3. 📊 Taux de conversion_A  
# 4. 🔥 Touches surface_A  
# 5. 🔑 Passes clés_A  
# 6. 🎯 Tirs tentés_A  
# 7. 🛡️ Interceptions_A  
...
# 13. ⚠️ Corners_A  
# 14. 📊 Forme récente_A  
# 15. ⭐ Points sur 5 matchs_A  

# Équipe B (Extérieur) Variables (similaires) :
...
if st.button("Prédire le Résultat"):
    ...
    # Ici, on suppose pour simplifier que les probabilités prédites du modèle de classification s'appliquent
    # à l'issue Victoire Équipe A et inversement pour Équipe B.
    # Pour un match nul, on peut prendre la moyenne.
