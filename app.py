...
attack1 = st.number_input("Force d'attaque", min_value=0, max_value=100, value=50)
defense1 = st.number_input("Force de défense", min_value=0, max_value=100, value=50)
injuries1 = st.number_input("Blessures", min_value=0, max_value=10, value=0)
motivation1 = st.number_input("Motivation", min_value=0, max_value=10, value=5)
tactic1 = st.number_input("Tactique (0-10)", min_value=0, max_value=10, value=5)
h2h1 = st.number_input("Historique face-à-face", min_value=0, max_value=10, value=5)
xg1 = st.number_input("xG (Expected Goals)", min_value=0.0, max_value=5.0, value=1.5)
corners1 = st.number_input("Nombre de corners", min_value=0, max_value=10, value=5)
yellow_cards1 = st.number_input("Cartons jaunes", min_value=0, max_value=10, value=2)
red_cards1 = st.number_input("Cartons rouges", min_value=0, max_value=10, value=0)
possession1 = st.number_input("Possession (%)", min_value=0, max_value=100, value=50)
away_advantage1 = st.number_input("Avantage extérieur (0-10)", min_value=0, max_value=10, value=5)
home_advantage1 = st.number_input("Avantage domicile (0-10)", min_value=0, max_value=10, value=5)

# Variables modifiables pour l'équipe 2
st.header("Données Équipe 2")
attack2 = st.number_input("Force d'attaque", min_value=0, max_value=100, value=50)
defense2 = st.number_input("Force de défense", min_value=0, max_value=100, value=50)
injuries2 = st.number_input("Blessures", min_value=0, max_value=10, value=0)
motivation2 = st.number_input("Motivation", min_value=0, max_value=10, value=5)
tactic2 = st.number_input("Tactique (0-10)", min_value=0, max_value=10, value=5)
h2h2 = st.number_input("Historique face-à-face", min_value=0, max_value=10, value=5)
xg2 = st.number_input("xG (Expected Goals)", min_value=0.0, max_value=5.0, value=1.5)
corners2 = st.number_input("Nombre de corners", min_value=0, max_value=10, value=5)
yellow_cards2 = st.number_input("Cartons jaunes", min_value=0, max_value=10, value=2)
red_cards2 = st.number_input("Cartons rouges", min_value=0, max_value=10, value=0)
possession2 = st.number_input("Possession (%)", min_value=0, max_value=100, value=50)
away_advantage2 = st.number_input("Avantage extérieur (0-10)", min_value=0, max_value=10, value=5)
home_advantage2 = st.number_input("Avantage domicile (0-10)", min_value=0, max_value=10, value=5)
...
if st.button("Générer les Prédictions"):
    ...
    if results:
        ...
        st.write(f"Random Forest (K=5): {results['rf_cv_score']}")
        st.write(f"XGBoost (K=5): {results['xgb_cv_score']}")
