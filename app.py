...
def calculate_forces(data):
    attack_strength = data['buts_marques'] / data['matchs_joues'] if data['matchs_joues'] > 0 else 0
    defense_strength = data['buts_subis'] / data['matchs_joues'] if data['matchs_joues'] > 0 else 0
...
# Données fictives pour l'équipe 1 et l'équipe 2
team1_data = {
    ...
    '⚽xG': 1.4,
    '🔝 Nombre de corners': 5,
    'buts_marques': 30,  # Valeur fictive pour les buts marqués
    'matchs_joues': 15,  # Valeur fictive pour les matchs joués
    'buts_subis': 18  # Valeur fictive pour les buts subis
}
...
team2_data = {
    ...
    '⚽xG': 1.2,
    '🔝 Nombre de corners': 6,
    'buts_marques': 25,  # Valeur fictive pour les buts marqués
    'matchs_joues': 14,  # Valeur fictive pour les matchs joués
    'buts_subis': 20  # Valeur fictive pour les buts subis
}
